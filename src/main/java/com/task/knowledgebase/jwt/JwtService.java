package com.task.knowledgebase.jwt;

import com.task.knowledgebase.repository.UserRepo;
import com.task.knowledgebase.userdetails.KnowledgeBaseUserDetails;
...
@Service
    public class JwtService {
        ...
        private final KnowledgeBaseUserDetailsService knowledgeBaseUserDetailsService;

        public JwtService(UserRepo userRepository, KnowledgeBaseUserDetailsService platformUserDetailsService) {
            this.userRepository = userRepository;
            this.knowledgeBaseUserDetailsService = platformUserDetailsService;
        }
        ...
        public String generateToken(UserDetails userDetails) {
            ...
            String email = ((KnowledgeBaseUserDetails) userDetails).getEmail();
